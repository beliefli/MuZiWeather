...
/**
 * Created by 11630 on 2017/12/13.
 */
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallBackListener() {
            ...
            public void succeed(String responseDate) {
                if ("countyCode".equals(type)) {
                    if (!TextUtils.isEmpty(responseDate)) { // 从服务器返回的数据中解析出天气代号
                        String[] array = responseDate.split("\\|");
                    ...
                    // 处理服务器返回的天气信息
                    DataUtil.handleWeatherResponse(WeatherActivity.this,
                            responseDate);
